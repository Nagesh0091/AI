...
DRIVER_PATH = r'C:\Users\Nagesh Agrawal\OneDrive\Desktop\AI\chromedriver-win64' # e.g. 'C:\\Users\\Username\\chromedriver_win32\\chromedriver'
wd = webdriver.Chrome()
...
class GoogleScraper():
    ...
    def scrape_images(self, query:str, folder_path= r'C:\Users\Nagesh Agrawal\OneDrive\Desktop\AI'):
